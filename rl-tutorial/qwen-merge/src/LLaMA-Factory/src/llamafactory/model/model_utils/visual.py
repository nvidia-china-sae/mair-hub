...
_register_composite_model(
    model_type="qwen_merge_vl",
    projector_key="visual.merger",
    vision_model_keys=["visual.patch_embed", "visual.blocks"],
    language_model_keys=["language_model"] if is_transformers_version_greater_than("4.51.0") else ["model", "lm_head"],
    lora_conflict_keys=["patch_embed"],
)

_register_composite_model(
    model_type="qwen_merge_vl_pt",
    projector_key="visual.merger",
    vision_model_keys=["visual.patch_embed", "visual.blocks"],
    language_model_keys=["language_model"] if is_transformers_version_greater_than("4.51.0") else ["model", "lm_head"],
    lora_conflict_keys=["patch_embed"],
