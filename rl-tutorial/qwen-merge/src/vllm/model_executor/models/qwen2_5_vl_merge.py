...
from transformers.models.qwen2_5_vl_merge.configuration_qwen2_5_vl_merge import (
    Qwen2_5_VL_MergeConfig, Qwen2_5_VL_MergeVisionConfig)
...
class Qwen2_5_VisionPatchMerger(nn.Module):
    ...
    def __init__(
        ...
        self.mlp = nn.ModuleList([
            ...
            nn.GELU(),
            ColumnParallelLinear(d_model,
                              d_model_2,
                              bias=True,
                              gather_output=True,  # 确保输出是完整的张量
                              quant_config=quant_config,
                              prefix=f"{prefix}.mlp.4" 
                            )
            ])
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        mlp_fc1, mlp_act, mlp_fc2, mlp_act2, mlp_fc3 = self.mlp
...
class Qwen2_5_VisionTransformer(nn.Module):
    ...
    def __init__(
        self,
        vision_config: Qwen2_5_VL_MergeVisionConfig,
        norm_eps: float = 1e-6,
        quant_config: Optional[QuantizationConfig] = None,
        prefix: str = "",
    ) -> None:
        ...
        self.merger = Qwen2_5_VisionPatchMerger(
            ...
            d_model_2=vision_config.out_hidden_size2,
...
class Qwen2_5_VLProcessingInfo(Qwen2VLProcessingInfo):
    ...
    def get_hf_config(self):
        return self.ctx.get_hf_config(Qwen2_5_VL_MergeConfig)
...
class Qwen2DecoderLayerMerge(nn.Module):
...
class Qwen2ForCausalLMMerge(nn.Module, SupportsLoRA, SupportsPP):
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        ...
        self.model = Qwen2Model(vllm_config=vllm_config,
                                ...
                                decoder_layer_type=Qwen2DecoderLayerMerge)
...
class Qwen2_5_VL_MergeForConditionalGeneration(nn.Module, SupportsMultiModal,
    ...
    hf_to_vllm_mapper = WeightsMapper(orig_to_new_prefix={
        ...
        "model.language_model.": "language_model.model.",  # 优先匹配更具体的模式
        "model.visual": "visual",
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        super().__init__()
        config: Qwen2_5_VL_MergeConfig = vllm_config.model_config.hf_config
        quant_config = vllm_config.quant_config
        ...
        self.language_model = init_vllm_registered_model(
            ...
            architectures=["Qwen2ForCausalLMMerge"],
        )
