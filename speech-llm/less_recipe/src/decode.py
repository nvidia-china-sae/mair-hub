...
def main():
    ...
    aishell2_test_dl = aishell.test_dataloaders(aishell.aishell2_test_cuts())
    wenet_test_dl = aishell.test_dataloaders(aishell.wenet_test_cuts())
    test_sets = ["valid", "test", "aishell2", "wenet"]
    test_dls = [valid_dl, test_dl, aishell2_test_dl, wenet_test_dl]
